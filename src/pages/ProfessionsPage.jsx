...
const ProfessionsPage = () => {
  ...
  const professions = [
    { german: "der Arzt / die Ärztin", english: "doctor", example: "Mein Vater ist Arzt." },
    { german: "der Lehrer / die Lehrerin", english: "teacher", example: "Sie ist Lehrerin." },
    { german: "der Ingenieur / die Ingenieurin", english: "engineer", example: "Er arbeitet als Ingenieur." },
    { german: "der Student / die Studentin", english: "student", example: "Ich bin Student." },
    { german: "der Anwalt / die Anwältin", english: "lawyer", example: "Sie ist Anwältin." },
    { german: "der Verkäufer / die Verkäuferin", english: "salesperson", example: "Er arbeitet im Supermarkt." },
    { german: "der Koch / die Köchin", english: "cook / chef", example: "Sie ist Köchin." },
    { german: "der Fahrer / die Fahrerin", english: "driver", example: "Er ist Busfahrer." },
    { german: "der Musiker / die Musikerin", english: "musician", example: "Sie spielt Geige." },
    { german: "der Rentner / die Rentnerin", english: "retiree", example: "Meine Oma ist Rentnerin." }
  ];

  const phrases = [
    { german: "Was sind Sie von Beruf?", english: "What is your profession?" },
    { german: "Ich arbeite als ...", english: "I work as ..." },
    { german: "Wo arbeiten Sie?", english: "Where do you work?" },
    { german: "Ich bin selbstständig.", english: "I am self-employed." }
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
      <div className="bg-white/70 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">💼 Professions & Jobs</h2>
        <p className="text-center text-gray-600 mb-8 text-sm md:text-base">
          Learn to talk about occupations and ask about someone's job.
        </p>

        <div className="bg-white rounded-xl p-5 shadow-md mb-6">
          <h3 className="text-xl font-bold text-purple-700 mb-3">📌 Professions</h3>
          <div className="grid md:grid-cols-2 gap-3">
            {professions.map(p => (
              <div key={p.german} className="bg-gray-50 p-2 rounded flex justify-between items-center">
                ...
                <PronounceButton word={p.german.split(' / ')[0]} />
              </div>
            ))}
          </div>
        </div>
