...
const TrainTicketPage = () => {
  ...
  const vocabulary = [
    { german: "das Ticket / die Fahrkarte", english: "ticket", example: "Ein Ticket nach Berlin, bitte." },
    { german: "der Bahnhof", english: "train station", example: "Der Bahnhof ist groß." },
    { german: "das Gleis", english: "platform", example: "Von Gleis 3." },
    { german: "die Abfahrt", english: "departure", example: "Die Abfahrt ist um 10 Uhr." },
    { german: "die Ankunft", english: "arrival", example: "Die Ankunft ist um 12 Uhr." },
    { german: "der Zug", english: "train", example: "Der Zug kommt pünktlich." }
  ];

  const phrases = [
    { german: "Eine Fahrkarte nach München, bitte.", english: "A ticket to Munich, please." },
    { german: "Einfach oder hin und zurück?", english: "One way or round trip?" },
    { german: "Wann fährt der nächste Zug?", english: "When does the next train leave?" },
    { german: "Muss ich umsteigen?", english: "Do I have to change trains?" },
    { german: "Ist der Zug verspätet?", english: "Is the train delayed?" }
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
      <div className="bg-white/70 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">🚆 Buying a Train Ticket</h2>
        <p className="text-center text-gray-600 mb-8 text-sm md:text-base">
          Essential phrases for buying tickets and navigating the train station.
        </p>
        ...
        <div className="mt-8 p-5 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl">
          ...
          {!quizMode ? (
            ...
            <div className="text-center">
              ...
              <input type="text" value={userAnswer} onChange={(e) => setUserAnswer(e.target.value)} placeholder="e.g., das Ticket" className="w-full p-3 border rounded-xl mb-3" />
